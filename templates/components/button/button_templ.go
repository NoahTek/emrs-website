...
// templui component button - version: v1.11.0 installed by templui v1.11.0
...
func (b Props) variantClasses() string {
	...
	case VariantGhost:
		return "hover:bg-secondary hover:text-secondary-foreground dark:hover:bg-secondary/50"
	case VariantLink:
